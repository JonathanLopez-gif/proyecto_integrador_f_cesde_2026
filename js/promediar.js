/**
 * @author JusCoder
 * Este script realiza la validación de la operación APP.
 */
...
function agregarNotas(){
    ...
    // Validar las notas si están vacías
    if(not1==="" || not2==="" || not3===""){
        
        swal("Ingese las notas por favor", "La notas no pueden ser vacios", "warning");return false;
        
    }
    //Validar las notas, no mayor de 21 puntos, solo hasta 20
    ...
    var  obs =0;
    //Promedio mayor o igual a 2.8 entonces aprobado, caso contrario desaprobado
    if(prom >=2.8){
